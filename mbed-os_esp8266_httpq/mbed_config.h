...
#define MBED_CONF_APP_WIFI_PASSWORD                                           "youdiditfreakonwpa2_don't_forget_!T"                                                                                       // set by application
#define MBED_CONF_APP_WIFI_SSID                                               "Del Basso Cable"                                                                                           // set by application
