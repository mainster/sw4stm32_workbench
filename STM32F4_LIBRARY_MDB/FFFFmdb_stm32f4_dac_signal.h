...
@endverbatim
 */
#ifndef __TM_DAC_SIGNAL_H
#define __TM_DAC_SIGNAL_H 
...
struct TM_DAC_SIGNAL_Signal_tt TM_DAC_SIGNAL_Signal_t;
typedef TM_DAC_SIGNAL_Result_tt TM_DAC_SIGNAL_Result_t;
/**
 * @}
 */
