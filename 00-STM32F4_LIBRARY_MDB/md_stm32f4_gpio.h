 ...
 *
 */
#ifndef MD_STM32F4_GPIO_H_
#define MD_STM32F4_GPIO_H_
 ...
 * @{
 *
 * GPIO library is a user level implementation of Std/HAL driver GPIO library.
 *
 ...
 * @brief       GPIO Typedef is used to improve initialization/access method structure.
 * @{
 */
 ...
 *
 * A lower driving strength means
 ...
 */
typedef enum {
	MD_GPIO_PuPd_None = 0x00, /*!< No pull resistor */
 ...
 * @param[in]  GPIO_Mode   Pass GPIO logic/driver mode for GPIO_Pin (see @ref MD_GPIO_Mode_t enumeration typedef).
 * @param[in]  GPIO_OType  Pass GPIO driver stage type for GPIO_Pin (see @ref MD_GPIO_OType_t enumeration typedef).
 * @param[in]  GPIO_PuPd   Select GPIO pull resistors for GPIO_Pin (see @ref MD_GPIO_PuPd_t enumeration typedef).
 * @param[in]  GPIO_Speed  Select GPIO driver speed for GPIO_Pin (see @ref MD_GPIO_Speed_t enumeration typedef).
 */
void MD_GPIO_Init(GPIO_TypeDef *GPIOx, uint16_t GPIO_Pin, MD_GPIO_Mode_t GPIO_Mode,
 ...
 */
void MD_GPIO_InitAlternate(GPIO_TypeDef *GPIOx, uint16_t GPIO_Pin, MD_GPIO_OType_t GPIO_OType,
