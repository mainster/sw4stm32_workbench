...
typedef enum {
	...
	TM_USART_PinsPack_2 = 0x01,     /*!< Select PinsPack2 from Pinout table for specific USART */
	TM_USART_PinsPack_3 = 0x02,     /*!< Select PinsPack3 from Pinout table for specific USART */
	TM_USART_PinsPack_Custom = 0x03, /*!< Select custom pins for specific USART, callback will be called, look @ref TM_USART_InitCustomPinsCallback */
} TM_USART_PinsPack_t;
